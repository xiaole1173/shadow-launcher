...
Rectangle {
    ...
    Loader {
        ...
        function handleRpGoBack() { page._showRpDetail = false }
        ...
        onLoaded: {
            ...
            item.goBack.connect(rpDetailLoader.handleRpGoBack)
        }
    }
    ...
    Loader {
        ...
        function handleModGoBack() { page._showModDetail = false }
        ...
        onLoaded: {
            ...
            item.goBack.connect(modDetailLoader.handleModGoBack)
        }
    }
