...
// ============================================================
static const QString LOGIN_PFX = QStringLiteral("versionLogin/");

int SettingsBackend::versionLoginType(const QString& versionId) const
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    return s.value(LOGIN_PFX + versionId + QStringLiteral("/loginType"), 0).toInt();
}

void SettingsBackend::setVersionLoginType(const QString& versionId, int type)
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    s.setValue(LOGIN_PFX + versionId + QStringLiteral("/loginType"), type);
    s.sync();
}

QString SettingsBackend::versionAuthServer(const QString& versionId) const
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    return s.value(LOGIN_PFX + versionId + QStringLiteral("/authServer"), QString()).toString();
}

void SettingsBackend::setVersionAuthServer(const QString& versionId, const QString& url)
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    s.setValue(LOGIN_PFX + versionId + QStringLiteral("/authServer"), url);
    s.sync();
}

QString SettingsBackend::versionAuthRegisterUrl(const QString& versionId) const
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    return s.value(LOGIN_PFX + versionId + QStringLiteral("/registerUrl"), QString()).toString();
}

void SettingsBackend::setVersionAuthRegisterUrl(const QString& versionId, const QString& url)
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    s.setValue(LOGIN_PFX + versionId + QStringLiteral("/registerUrl"), url);
    s.sync();
}

QString SettingsBackend::versionLoginUsername(const QString& versionId) const
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    return s.value(LOGIN_PFX + versionId + QStringLiteral("/username"), QString()).toString();
}

void SettingsBackend::setVersionLoginUsername(const QString& versionId, const QString& username)
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    s.setValue(LOGIN_PFX + versionId + QStringLiteral("/username"), username);
    s.sync();
}

QString SettingsBackend::versionLoginPassword(const QString& versionId) const
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    return s.value(LOGIN_PFX + versionId + QStringLiteral("/password"), QString()).toString();
}

void SettingsBackend::setVersionLoginPassword(const QString& versionId, const QString& password)
{
    QSettings s(QCoreApplication::organizationName(),
                QCoreApplication::applicationName());
    s.setValue(LOGIN_PFX + versionId + QStringLiteral("/password"), password);
    s.sync();
}
