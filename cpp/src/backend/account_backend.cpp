...
QString AccountBackend::renderHead3D(const QString& skinPath)
{
    ...
    bool hat = false; // DEBUG: force off  // always try hat; alpha<64 filter handles transparency
    float pad = 0.30f;
