...
void ModpackImporter::startImport(const QString& zipFilePath, const QString& versionName, bool includeOptional, const QString& iconUrl)
{
    ...
    m_task->start(zipFilePath, versionName, includeOptional, iconUrl);
}
