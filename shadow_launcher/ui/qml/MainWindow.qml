                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { text: ; font.pixelSize: 16; font.weight: Font.Bold"閺堫亪鈧瀚ㄧ増鏈?; font.pixelSize: 16; font.weight: Font.Bold"; color: currentSelectedVersion ? "#8aa8f0" : "#787c90" }
                                    }
                                }
                                ...
                                Rectangle {
                                    ...
                                    color: "#3a4eb8"
                                    Text { anchors.centerIn: parent; "; font.pixelSize: 15; font.weight: Font.Bold; color: "#e8ecf8"鍚姩娓告垙"; font.pixelSize: 15; font.weight: Font.Bold; color: "#e8ecf8" }
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        Text { anchors.centerIn: parent; "; font.pixelSize: 13; font.weight: Font.Bold; color: "#e8ecf8"鍚姩"; font.pixelSize: 13; font.weight: Font.Bold; color: "#e8ecf8" }
                                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                                            onClicked: {
                                                if (!backend) return
                                ...
                                ColumnLayout {
                                    ...
                                    Flow {
                                        ...
                                        Rectangle { width: 130; height: 32; radius: 6; color: shortcutHoverCp.hovered ? "#2538b0" : "#3a4eb8"
                                            Text { anchors.centerIn: parent; "; font.pixelSize: 11; color: "#e8ecf8"棣冩惖 澶嶅埗版本璺緞"; font.pixelSize: 11; color: "#e8ecf8" }
                                ...
                                ColumnLayout {
                                    ...
                                    Flow {
                                        ...
                                        Rectangle { width: 110; height: 32; radius: 5; color: migrateHover.hovered ? "#1a2848" : "#0d1018"; border.color: "#1a1f2e"
                                            Text { anchors.centerIn: parent; text: "迁移目录"; font.pixelSize: 11; color: "#c0c8d8" }
