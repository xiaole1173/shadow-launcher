                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { text: currentSelectedVersion || "閺堫亪鈧瀚ㄧ増鏈?; font.pixelSize: 16; font.weight: Font.Bold"; color: currentSelectedVersion ? "#8aa8f0" : "#787c90" }
                                    }
                                }
                                ...
                                Rectangle {
                                    ...
                                    color: "#3a4eb8"
                                    Text { anchors.centerIn: parent; text: "启动娓告垙"; font.pixelSize: 15; font.weight: Font.Bold; color: "#e8ecf8" }
                                                    ...
                                                    onPressed: function(mouse) {
                                                        if (mouse.button === Qt.RightButton) {
                                                            if (index === 0) {
                                                                ...
                                                                confirmDialog.message = "是否移除" + model.display + " 禄锛焠\n（不会删除本地文件）"
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    // Shortcuts
                                    Text { text: "快捷入口"; font.pixelSize: 10; color: "#787c90"; font.letterSpacing: 1.5 }
                                    Flow {
                                        Layout.fillWidth: true; spacing: 8
                                        ...
                                        Rectangle { width: 130; height: 32; radius: 6; color: shortcutHover7.hovered ? "#2538b0" : "#3a4eb8"
                                            ...
                                            MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                                                onClicked: { if (backend && !backend.openLatestLog()) showToast("未找到启动日志") }
                                            }
                                        }
                                ...
                                ColumnLayout {
                                    ...
                                    Flickable {
                                        ...
                                        ColumnLayout {
                                            ...
                                            // 閼奉亜濮╅崘鍛摠
                                            RowLayout {
                                                Text { text: "自动内存"; font.pixelSize: 12; color: "#c0c8d8" }
                                                Item { Layout.fillWidth: true }
                                                Switch {
                                            ...
                                            // 版本闅旂顬?
                                            Text { text: "版本行为"; font.pixelSize: 12; font.weight: Font.DemiBold; color: "#e4e8f2"; Layout.topMargin: 8 }
                                            RowLayout {
                                                Text { text: "版本隔离（模组配置/存档独立）"; font.pixelSize: 12; color: "#c0c8d8" }
                                                Item { Layout.fillWidth: true }
                                                Switch {
                                            ...
                                            // 启动后关闭启动器
                                            RowLayout {
                                                Text { text: "启动后关闭启动器"; font.pixelSize: 12; color: "#c0c8d8" }
                                                Item { Layout.fillWidth: true }
                                                Switch {
                                        ...
                                        delegate: Rectangle {
                                            ...
                                            RowLayout {
                                                ...
                                                Rectangle { width: 20; height: 20; radius: 3; color: isDir ? "#5060a0" : "#3a6040"
                                                    Text { anchors.centerIn: parent; text: isDir ? "打开" : "删除"; font.pixelSize: 10 }
                                                }
                                                Text { text: name; font.pixelSize: 12; color: "#d4d8e8"; Layout.fillWidth: true; elide: Text.ElideRight }
                                                Text { text: sizeDisplay; font.pixelSize: 10; color: "#9498a8" }
                                ...
                                ColumnLayout {
                                    ...
                                    Text { text: "查看、备份和管理你的游戏存档。"; font.pixelSize: 11; color: "#9498a8" }
                                ...
                                ColumnLayout {
                                    ...
                                    // Version tools
                                    Text { text: "版本工具"; font.pixelSize: 10; color: "#787c90"; font.letterSpacing: 1.5 }
                                    Flow {
                                        Layout.fillWidth: true; spacing: 8

                                        // Clone
                                        Rectangle { width: 110; height: 32; radius: 5; color: cloneHover.hovered ? "#1a2848" : "#0d1018"; border.color: "#1a1f2e"
                                            Text { anchors.centerIn: parent; text: "克隆版本"; font.pixelSize: 11; color: "#c0c8d8" }
