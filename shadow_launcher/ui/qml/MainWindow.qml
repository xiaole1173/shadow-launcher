        ...
        RowLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    ListModel {
                        id: navModel
                        ListElement { label: "閸氼垰濮?; pageKey: "home" }
                ...
                Rectangle {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                Rectangle {
                                    ...
                                    Text { anchors.centerIn: parent; text: "閫夋嫨宸茬櫥褰曡处鍙?; color: "#606478"; font.pixelSize: 13 }
                    ...
                    Rectangle {
                        ...
                        Rectangle { x: 16; y: 16; height: 28; width: 80; radius: 5; color: "transparent"
                            Text { anchors.centerIn: parent; text: "\u2190 杩斿洖閸氼垰濮?; color: "#505468"; font.pixelSize: 12 }
                                    ...
                                    RowLayout {
                                        ...
                                        Rectangle {
                                            ...
                                            RowLayout {
                                                ...
                                                Text { text: sortBtn.versionSortIndex === 0 ? "閳?鐗堟湰" : (sortBtn.versionSortIndex === 1 ? "閳?鐗堟湰" : (sortBtn.versionSortIndex === 2 ? "閳?澶у皬" : "閳?妯＄粍")); font.pixelSize: 10; color: "#9094a8" }
                                            }
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        Text { anchors.centerIn: parent; text: "閳?杩斿洖"; font.pixelSize: 11; color: "#707488" }
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        RowLayout {
                                            ...
                                            Rectangle { width: 1; height: 32; color: "#1a1f2e" }
                                            ColumnLayout { Layout.fillWidth: true; spacing: 2
                                                Text { text: "鐗堟湰闅旂顬?; font.pixelSize: 10; color: "#505468" }
                                    ...
                                    Flow {
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover0.hovered ? "#2538b0" : "#3a4eb8"
                                            Text { anchors.centerIn: parent; text: "馃摟 鐗堟湰鏂囦欢澶?; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover1.hovered ? "#2538b0" : "#3a4eb8"
                                            Text { anchors.centerIn: parent; text: "馃搼 瀛樻。鏂囦欢澶?; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover6.hovered ? "#2538b0" : "#3a4eb8"
                                            Text { anchors.centerIn: parent; text: "棣冩惖 logs 鏃ュ織"; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 130; height: 32; radius: 6; color: shortcutHoverCp.hovered ? "#2538b0" : "#3a4eb8"
                                            Text { anchors.centerIn: parent; text: "棣冩惖 澶嶅埗鐗堟湰璺緞"; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover3.hovered ? "#2538b0" : "#4a5ec8"
                                            ...
                                            Text { anchors.centerIn: parent; text: "棣冃?Mod 鏂囦欢澶?"; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover4.hovered ? "#2538b0" : "#4a5ec8"
                                            visible: backend ? backend.isModdedVersion(currentSelectedVersion) : false
                                            Text { anchors.centerIn: parent; text: "閳?config 閰嶇疆"; font.pixelSize: 11; color: "#e8ecf8" }
                                        ...
                                        Rectangle { width: 120; height: 32; radius: 6; color: shortcutHover5.hovered ? "#2538b0" : "#4a5ec8"
                                            visible: backend ? backend.isModdedVersion(currentSelectedVersion) : false
                                            Text { anchors.centerIn: parent; text: "閴?鍏夊奖鍖?"; font.pixelSize: 11; color: "#e8ecf8" }
                                ...
                                ColumnLayout {
                                    ...
                                    Flickable {
                                        ...
                                        ColumnLayout {
                                            ...
                                            // Java 鐜顖氼暔
                                            Text { text: "Java 鐜顖氼暔"; font.pixelSize: 12; font.weight: Font.DemiBold; color: "#d0d4e0" }
                                            ...
                                            Rectangle {
                                                ...
                                                Rectangle { anchors.right: parent.right; anchors.rightMargin: 102; anchors.verticalCenter: parent.verticalCenter
                                                    ...
                                                    Text { anchors.centerIn: parent; text: "娴忚顫?; font.pixelSize: 11; color: "#9094a8" }
                                            ...
                                            Text {
                                                text: {
                                                    ...
                                                    if (compat === "recommended") return base + "  閴?鎺ㄨ崘"
                                                    if (compat === "compatible") return base + "  閳?鍏煎顔?
                                                    if (compat === "incompatible") return base + "  閴?涓嶅吋瀹?"
                                            ...
                                            // 棰勮顔?
                                            Text { text: "棰勮顔?; font.pixelSize: 10; color: "#505468" }
                                            Flow {
                                                Layout.fillWidth: true; spacing: 8
                                                Repeater {
                                                    model: [
                                            ...
                                            RowLayout {
                                                Text { text: "鐗堟湰闅旂顬囬敍鍫熌佺紒?閰嶇疆/鐎涙ɑ銆傞悪顒傜彌閿?"; font.pixelSize: 12; color: "#a0a5b8" }
                                                Item { Layout.fillWidth: true }
                                                Switch {
                                            ...
                                            Text { text: "锛堢ず渚? --width 1920 --height 1080 --fullscreen閿?"; font.pixelSize: 9; color: "#505468" }
                                ...
                                ColumnLayout {
                                    ...
                                    Text { text: "閹殿偅寮块柅澶婄暰鐗堟湰閻ㄥ嫭鐖堕幋蹇旀瀮娴犺泛鐣弫瀛樷偓褝绱濆Λ鈧弻銉﹀疮閸у繑鍨ㄧ己澶遍惃鍕瀮娴犺翰鈧?"; font.pixelSize: 11; color: "#606478"; wrapMode: Text.WordWrap; Layout.fillWidth: true }
                                    ...
                                    Rectangle {
                                        ...
                                        visible: verifyResultLabel.text.indexOf("娑擃亝鏋冩禒鑸垫箒闂傤噣顣?) > 0 || verifyResultLabel.text.indexOf("鎹熷潖") > 0 || verifyResultLabel.text.indexOf("缂哄け") > 0
                                        ...
                                        Rectangle { width: 110; height: 32; radius: 5; color: cloneHover.hovered ? "#1a2848" : "#0d1018"; border.color: "#1a1f2e"
                                            ...
                                            MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                                                onClicked: {
                                                    ...
                                                    showToast("宸插厠闅嗙増鏈? " + currentSelectedVersion) }
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            onClicked: {
                                                ...
                                                confirmDialog.message = "纭畾瑕佸垹闄ょ増鏈?芦 " + currentSelectedVersion + " 绂?鍚楋紵\n濮濄倖鎼锋担婊€绗夐崣顖涙寵闁库偓閿涘瞼澧楅張顒佹瀮娴犺泛銇欑亸鍡氼潶濮橀晲绠欏垹闄ら妴?"
